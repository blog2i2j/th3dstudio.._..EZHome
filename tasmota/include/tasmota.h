...
#ifdef ESP8266
  const uint32_t HLW_PREF_PULSE = 12102;      // Calibration done with 60W Resistive Load @ 120V 60hz US - Calibrated with Kill-A-Watt
  const uint32_t HLW_UREF_PULSE = 1727;       // 
  const uint32_t HLW_IREF_PULSE = 3842;       // Last Calibration done on 3/4/2022 by TDH
#endif

#ifdef ESP32
  const uint32_t HLW_PREF_PULSE = 9058;       // Calibration done with 60W Resistive Load @ 120V 60hz US - Calibrated with Kill-A-Watt
  const uint32_t HLW_UREF_PULSE = 1465;       // 
  const uint32_t HLW_IREF_PULSE = 3142;       // Last Calibration done on 10/8/2024 by TDH
#endif
